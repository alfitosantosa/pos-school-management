...
// Type for creating new users (without id, as it will be generated by backend)
type UserDataInput = Omit<UserDataTypes, "id" | "createdAt" | "updatedAt" | "user" | "academicYear" | "class" | "major" | "role" | "tahfidzGroup">;
